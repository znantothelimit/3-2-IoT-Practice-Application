...
/* Grade 3 , Semester 2 , Chapter 8 , Number 3 */
...
int main(void)
{
    int smokeChannel = 2; // ADC 채널 변수 선언
    int smokeValue = 0;   // ADC 값 변수 선언
    ...
    while(1)
    {
        smokeValue = ReadMcp3208ADC(smokeChannel); // ADC 채널에 입력되는 값을 변환하여 ADC 값 변수에 저장
